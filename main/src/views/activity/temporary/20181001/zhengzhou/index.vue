<template>
  <div class="guoqing-2018 guoqing-zhengzhou text-center">
    <div class="main-content overflow-hidden" v-if="!success">
      <h2 class="fz-18">赏月团圆会亲友，自由出行黄金周</h2>
      <h3 class="fz-40">7天租低至499元</h3>
      <h4 class="fz-14 bg-yellow">租车还送60元充电券，4000 根充电桩，充电便捷</h4>
      <mt-button type="default" @click="handleGetCoupon">领券用车，7天低至499</mt-button>
    ...
    <div class="success-page overflow-hidden" v-if="success">
      ...
      <div class="coupon position-relative">
        ...
        <span class="position-absolute">194</span>
      </div>
    ...
    <div class="rules position-fixed fullscreen flex-col align-items-center justify-content-center" v-show="ruleVisible">
      ...
      <div class="rule-container position-relative zindex-99 bg-white">
        ...
        <ul class="fz-16 text-left">
          <li>1.点击领取3张194元优惠券。</li>
          <li>2.每张优惠券满690可用，不限车型，海马7天短租低至499元。</li>
          <li>3.优惠券使用期2018.9.20-2018.10.8。</li>
          <li>4.使用优惠券下单，开始用车后，系统自动发放3张20元充电优惠券。</li>
          <li>5.领券活动有效期2018.9.20-2018.10.8。</li>
          <li>6.本活动仅限郑州地区。</li>
        </ul>
      </div>
...
export default {
  ...
  mounted() {
    this.$track('h5Activity20181001zzPageOpen')
  },
  ...
  methods: {
    handleGetCoupon() {
      ...
      this.$fetch('/php-service/activity/simple/mid-autumn-activity/ha', {
...
.guoqing-zhengzhou {
  .main-content {
    min-height: 100%;
    background-image: url('../img/bg-zz.png');
    background-size: 100%;
