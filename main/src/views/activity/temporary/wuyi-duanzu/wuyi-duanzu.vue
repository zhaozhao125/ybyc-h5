<template>
  <div class="wuyi-2018">
    <div class="top-title">
      ...
      <small>（此活动与优惠券不可叠加使用）</small>
      <p>活动时间 2018/04/25 - 2018/05/02</p>
    </div>
    <ul class="car-list">
    ...
    <div class="reserve-input">
      ...
      <div class="form-container">
        ...
        <div class="submit-btn" @click="handleSubmit">支付定金 50元</div>
        <div class="tip" @click="jumpOtherPage">
          <a>充值赠送仅剩最后一天，最高赠1000元＞</a>
        </div>
      </div>
    </div>
    <div class="activity-rule">
      ...
      <ul class="rules">
        <li>
          活动流程：
          <ul>
            <li>预定：支付定金后，即成功参与本活动，同时赠送20元优惠券包</li>
            <li>取车：4月25号-5月2号期间，前往任一分时网点下单用车即可</li>
            <li>还车：根据已预定的套餐时长，前往任一分时网点还车</li>
            <li>结算：还车后3个工作日，系统自动将优惠充值到钱包赠送余额（此活动与优惠券不可叠加使用）</li>
          </ul>
        </li>
        <li>50元定金将从你的钱包充值余额中扣除，还车后结算将与优惠金额一同返还</li>
        <li>若填写了取物料信息，在取车后即可前去取物料，还车前需归还</li>
        <li class="rule-zhengzhou" v-if="currentCity=='zhengzhou'">大科园店地址：西三环电厂路国家大学科技园12号楼一楼知豆体验店；
          <!-- <br>航海路店地址：航海路城东路向南50米路东； --><br>天伦路店地址：中州大道天伦路向西200米路北</li>
...
export default {
  ...
  data() {
    return {
      ...
      dateModel: null,
      startDate: new Date(2018, 4 - 1, 25),
  ...
  methods: {
    jumpOtherPage() {
      window.location.href = 'https://h5.1byongche.com/app/wallet/#/bonus-pay?type=balance'
    },
